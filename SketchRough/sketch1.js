...
//     });
//   }
//First automatic slide show and tab navigation(websites,prototype buttons)
let slideIndex6 = 0;
showSlides6();
...
setTimeout(showSlides, 2000); // Change image every 2 seconds
  ...
  setTimeout(showSlides3, 2000); // Change image every 2 seconds
   ...
   //Second tab navigation(view,test,organise buttons)
  //  function openNav(fea){
  //   var i;
  ...
  // }
  // // Add active class to the current button (change the btn highlight it)
  // var header = document.getElementById("myBtn1");
  // var btns = header.getElementsByClassName("link1");
  // for (var i = 0; i < btns.length; i++) {
  //   btns[i].addEventListener("click", function() {
  //   var current = document.getElementsByClassName("activeclr");
  //   current[0].className = current[0].className.replace(" activeclr", " ");
  //   this.className += " activeclr";
  //   });
  // }
